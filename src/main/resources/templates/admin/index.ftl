...
<body>
	      ...
	      <div class="container-fluid">
	        ...
	        <div id="navbar" class="navbar-collapse collapse">
	          <ul class="nav navbar-nav navbar-right">
	            <li class="active"><a href="#">${Session.admin.name!"Dashboard"}</a></li>
	            <li><a href="#">设置</a></li>
	            <li><a href="#">帮助</a></li>
	      ...
	      <div class="row">
	        <div class="col-sm-3 col-md-2 sidebar">
	          ...
	          <h5><i class="fa fa-globe" aria-hidden="true"></i>
                  <small><b>代理商管理中心</b></small>
              </h5>
	          <ul class="nav nav-sidebar">
	            <li class="active"><a href="#" onclick="nav(this, 'agent')">
	            	<i class="fa fa-briefcase" aria-hidden="true"></i>
	            	<span class="hidden-xs hidden-sm">代理商列表</span></a></li>
	            <li><a href="#" onclick="nav(this, 'agent/add')">
	            	<i class="fa fa-plus" aria-hidden="true"></i>
	            	<span class="hidden-xs hidden-sm">新增代理商</span></a></li>
	          </ul>
	          ...
	          <ul class="nav nav-sidebar">
	            <li><a href="#" onclick="nav(this, 'owner')">
	          ...
	          <ul class="nav nav-sidebar">
	            ...
	            <li><a href="#" onclick="nav(this, 'device/apply')">
	            	<i class="fa fa-bullhorn" aria-hidden="true"></i>
	            	<span class="hidden-xs hidden-sm">申请设备</span></a></li>
	            <li><a href="#" onclick="nav(this, 'device/add')">
	            	<i class="fa fa-plus" aria-hidden="true"></i>
	            	<span class="hidden-xs hidden-sm">新增设备</span></a></li>
	            <li><a href="#" onclick="nav(this, 'device/history')">
	            	<i class="fa fa-history" aria-hidden="true"></i>
	            	<span class="hidden-xs hidden-sm">申请记录</span></a></li>
	          </ul>
	        ...
	        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<iframe id="main" src="agent" style="border: none; width: 100%;"
	...
	function signout() {
		$.ajax({
			url: '${request.contextPath}/admin/signoutAction',
			dataType: 'json',
			success: function(data) {
				location = "${request.contextPath}/admin/signin";
			}
		});
	}
	</script>
